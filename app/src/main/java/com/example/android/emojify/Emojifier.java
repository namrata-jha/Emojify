...
public class Emojifier {
    ...
    static Bitmap detectFacesAndOverlay(Context context, Bitmap image){
        com.google.android.gms.vision.face.FaceDetector detector =
                ...
                .setTrackingEnabled(false).setClassificationType(com.google.android.gms.vision.face.FaceDetector.ALL_CLASSIFICATIONS)
                .build();
    ...
    private static Emoji whichEmoji(Face face){
        ...
        Log.i("MyLogs", "Smiling prob: "+face.getIsSmilingProbability());
        Log.i("MyLogs", "Left eye open prob: "+face.getIsLeftEyeOpenProbability());
        Log.i("MyLogs", "Right eye open prob: "+face.getIsRightEyeOpenProbability());
